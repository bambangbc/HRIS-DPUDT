...
class employee(osv.osv):
    ...
    _columns = {
        ...
        'jml_istri':fields.integer('Jumlah Istri'),
        'jml_anak':fields.integer('Jumlah Tanggungan'),
        'children':fields.integer('Jumlah Anak Balita'),
        'jml_tk':fields.integer('Jumlah Anak TK'),
        'jml_sd':fields.integer('Jumlah Anak SD'),
        'jml_smp':fields.integer('Jumlah Anak SMP'), 
        'jml_sma':fields.integer('Jumlah Anak SMA'),
        'jml_pt':fields.integer('Jumlah Anak PT'),
        ...
        'fingerprint_code':fields.char('fingerprint', 20),
...
class susunan_keluarga1(osv.osv):
    ...
    _columns= {
        ...
        'susunan':fields.selection([('Suami','Suami'),('Istri','Istri'),('anak1','Anak ke-1'),('anak2','Anak ke-2'),('anak3','Anak ke-3'),('anak4','Anak ke-4'),('anak5','Anak ke-5'),('anak6','Anak ke-6'),('anak7','Anak ke-7'),('saudara','Saudara/Kerabat')],'Status Dalam Keluarga'),
